...
\paragraph{Netzplan}
Ein Klassendiagramm, welches die Klassen der Anwendung und deren Beziehungen untereinander darstellt kann im \Anhang{app:Netzplan} eingesehen werden.
...
\begin{figure}[htb]
\centering
\includegraphicsKeepAspectRatio{netzplan.png}{0.9}
